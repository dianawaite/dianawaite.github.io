const apiURLb =
  "https://api.openweathermap.org/data/2.5/forecast?id=5607916&units=imperial&appid=375250a6426c22d4ea2c2d940a245bf9";
...
const apiURL =
  "https://api.openweathermap.org/data/2.5/weather?id=5607916&units=imperial&appid=375250a6426c22d4ea2c2d940a245bf9";
fetch(apiURL)
  .then((response) => response.json())
  .then((jsObject) => {
